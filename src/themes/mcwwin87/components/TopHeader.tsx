              ...
              <div className={`header__account ${acctOpen ? 'open' : ''}`} id="accountMenu" style={{ position: 'relative' }}>
                ...
                <div className="header__dropdown" style={{ display: acctOpen ? 'block' : 'none' }}>
                  ...
                  <div className="acct-group">
                    ...
                    <Link href="/player/account" className="acct-item" onClick={() => setAcctOpen(false)}><span className="acct-icon"><svg viewBox="0 0 24 24" width="15" height="15" fill="currentColor"><path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 3a3 3 0 1 1 0 6 3 3 0 0 1 0-6zm0 14.2a7.2 7.2 0 0 1-6-3.22c.03-1.99 4-3.08 6-3.08s5.97 1.09 6 3.08a7.2 7.2 0 0 1-6 3.22z"/></svg></span>My Account</Link>
