...
export default function TermsPage() {
  ...
  const bodyEn = `
          ...
          <p>The Service is owned by MCW Consultancy Ltd., a limited liability company registered in Anjouan with company registration number 15733, with registered address at Hamchako, Mutsamudu, Autonomous Island of Anjouan, Union of Comoros., (“Company”), licensed in the State of Anjouan under the Computer Gaming Licensing Act 007 of 2005.</p>
  ...
  const bodyBn = `
          ...
          <p>এই সেবার মালিক MCW Consultancy Ltd., যা Anjouan-এ নিবন্ধিত একটি সীমিত দায়বদ্ধ কোম্পানি, কোম্পানি নিবন্ধন নম্বর 15733, নিবন্ধিত ঠিকানা Hamchako, Mutsamudu, Autonomous Island of Anjouan, Union of Comoros., (“Company”), যা Computer Gaming Licensing Act 007 of 2005 এর অধীনে State of Anjouan-এ লাইসেন্সপ্রাপ্ত।</p>
