...
const FALLBACK_PAGES: Record<string, { title: string; body: string; titleBn?: string; bodyBn?: string }> = {
  'about-us': {
    ...
    body: `
      <p class="text-center">
          <a href="https://mcwbangladesh.co.com/" target="_blank" style="color: #b69853;">Nega Casino World (NCW)</a> is a leading online gaming website, offering sports betting, online casino, and online games. We have been serving the Asia Pacific market since 2015. We are fully licensed and regulated in various jurisdictions as stated in the Terms and Conditions and NCW operates strictly within these regulations.</p>

      <p class="text-center">
          The safe and private environment and the integrity of our products are the fundamental drivers of the NCW online gaming experience. We have the most advanced security measures available and are continually auditing our games and processes to ensure a totally safe and fair internet gambling experience. We keep all your information confidential, and we will never share it or sell it to third parties, except in accordance with our Privacy Policy.</p>

      <p class="text-center">
          We strive to offer the best prices whilst covering a wide variety of sporting markets and other worldwide sporting events. We provide a wide variety of live games and slot games in our casino. At NCW we promise you will enjoy the highest class of online gaming entertainment of the world.</p>
    ...
    bodyBn: `
      <p class="text-center"><a href="https://mcwbangladesh.co.com/" target="_blank" style="color: #b69853;">নেগা ক্যাসিনো ওয়ার্ল্ড (NCW)</a> একটি শীর্ষস্থানীয় অনলাইন গেমিং ওয়েবসাইট, যা স্পোর্টস বেটিং, অনলাইন ক্যাসিনো ও অনলাইন গেম অফার করে। আমরা ২০১৫ সাল থেকে এশিয়া প্যাসিফিক বাজারে সেবা দিয়ে আসছি। শর্তাবলীতে উল্লিখিত বিভিন্ন এখতিয়ারে আমরা সম্পূর্ণরূপে লাইসেন্সপ্রাপ্ত ও নিয়ন্ত্রিত, এবং NCW কঠোরভাবে এই নিয়মের মধ্যেই পরিচালিত হয়।</p>
      <p class="text-center">নিরাপদ ও গোপনীয় পরিবেশ এবং আমাদের পণ্যের সততা NCW অনলাইন গেমিং অভিজ্ঞতার মূল চালিকাশক্তি। আমাদের কাছে সর্বাধুনিক নিরাপত্তা ব্যবস্থা রয়েছে এবং সম্পূর্ণ নিরাপদ ও ন্যায্য অভিজ্ঞতা নিশ্চিত করতে আমরা নিয়মিত গেম ও প্রক্রিয়াগুলি অডিট করি। আমরা আপনার সব তথ্য গোপন রাখি এবং গোপনীয়তা নীতি অনুসারে ব্যতীত তা কখনও তৃতীয় পক্ষের সাথে শেয়ার বা বিক্রি করি না।</p>
      <p class="text-center">বিভিন্ন স্পোর্টস মার্কেট ও বিশ্বব্যাপী ক্রীড়া ইভেন্ট কভার করে আমরা সেরা মূল্য দেওয়ার চেষ্টা করি। আমাদের ক্যাসিনোতে নানা ধরনের লাইভ গেম ও স্লট গেম রয়েছে। NCW-তে আপনি বিশ্বের সর্বোচ্চ মানের অনলাইন গেমিং বিনোদন উপভোগ করবেন।</p>
  ...
  'privacy-policy': {
    ...
    body: `
      ...
      <p>This Privacy Policy explains how Nega Casino World uses your personal information when you are using one of our websites.</p>
      ...
      <p>Throughout this Privacy Policy, Nega Casino World together with our subsidiaries and affiliates (collectively, “we” or “us” or “our”) control the ways your Personal Data is collected and the purposes for which your Personal Data is used by Nega Casino World, acting as the “data controller” for the purposes of applicable European data protection legislation.</p>
      <h2>Our Data Protection Officer</h2>
      <p>If you have concerns or would like any further information about how Nega Casino World handles your personal information, you can contact our Data Protection Officer at <a href="mailto:support@megacasinoworld.com">support@megacasinoworld.com</a>.</p>
      ...
      <p>This data is collected when you:<br>• Register an account with Nega Casino World;<br>• Voluntarily provide it when using the website;<br>• Personally disclose the information in public areas of the website; and<br>• Provide it when you contact our customer support team</p>
      ...
      <p>If you choose to participate in any of the social features that we provide with our products (such as chat rooms) Nega Casino World may store records or otherwise process this data.</p>
      <h3>Non-personally identifiable information and traffic analysis</h3>
      <p>Nega Casino World strives to make our website as user friendly as possible and easy to find on the Internet. Nega Casino World collects data on how you use the site, which does not identify you personally. When you interact with the services, our servers keep an activity log unique to you that collects certain administrative and traffic information including: source IP address, time of access, date of access, web page(s) visited, language use, software crash reports and type of browser used. This information is essential for the provision and quality of our services.</p>
      <h3>Cookies</h3>
      <p>Nega Casino World uses cookies to ensure our website works efficiently and to enhance your visits to our platforms. Further information can be found in our Cookie Policy.</p>
      ...
      <p>Nega Casino World will use your identification document and/or proof of address to check your details in order for us to protect our users from fraudulent behavior and to promote responsible gambling.</p>
    ...
    bodyBn: `
      ...
      <p>এই গোপনীয়তা নীতি ব্যাখ্যা করে যে আপনি যখন আমাদের কোনো ওয়েবসাইট ব্যবহার করছেন তখন Nega Casino World কীভাবে আপনার ব্যক্তিগত তথ্য ব্যবহার করে।</p>
      ...
      <p>এই গোপনীয়তা নীতি জুড়ে, Nega Casino World তার সহযোগী প্রতিষ্ঠান ও অধিভুক্ত সংস্থাসমূহের সাথে (সম্মিলিতভাবে, “আমরা” বা “আমাদের”) আপনার ব্যক্তিগত তথ্য সংগ্রহের পদ্ধতি এবং যে উদ্দেশ্যে Nega Casino World আপনার ব্যক্তিগত তথ্য ব্যবহার করে তা নিয়ন্ত্রণ করে, প্রযোজ্য ইউরোপীয় ডেটা সুরক্ষা আইনের উদ্দেশ্যে “ডেটা কন্ট্রোলার” হিসেবে কাজ করে।</p>
      <h2>আমাদের ডেটা সুরক্ষা কর্মকর্তা</h2>
      <p>Nega Casino World কীভাবে আপনার ব্যক্তিগত তথ্য পরিচালনা করে সে সম্পর্কে আপনার কোনো উদ্বেগ থাকলে বা আরও তথ্য চাইলে, আপনি আমাদের ডেটা সুরক্ষা কর্মকর্তার সাথে <a href="mailto:support@megacasinoworld.com">support@megacasinoworld.com</a> এ যোগাযোগ করতে পারেন।</p>
      ...
      <p>এই ডেটা তখন সংগ্রহ করা হয় যখন আপনি:<br>• Nega Casino World এ একটি অ্যাকাউন্ট নিবন্ধন করেন;<br>• ওয়েবসাইট ব্যবহার করার সময় স্বেচ্ছায় তা প্রদান করেন;<br>• ওয়েবসাইটের সর্বজনীন অংশে ব্যক্তিগতভাবে তথ্য প্রকাশ করেন; এবং<br>• আমাদের গ্রাহক সহায়তা দলের সাথে যোগাযোগ করার সময় তা প্রদান করেন</p>
      ...
      <p>আমরা আমাদের পণ্যের সাথে যে সামাজিক বৈশিষ্ট্যগুলো প্রদান করি (যেমন চ্যাট রুম) সেগুলোর কোনোটিতে আপনি অংশগ্রহণ করতে বেছে নিলে Nega Casino World এই ডেটার রেকর্ড সংরক্ষণ করতে পারে বা অন্যভাবে প্রক্রিয়া করতে পারে।</p>
      <h3>ব্যক্তিগতভাবে অশনাক্তযোগ্য তথ্য এবং ট্রাফিক বিশ্লেষণ</h3>
      <p>Nega Casino World আমাদের ওয়েবসাইটকে যতটা সম্ভব ব্যবহারকারী-বান্ধব এবং ইন্টারনেটে সহজে খুঁজে পাওয়ার উপযোগী করার চেষ্টা করে। Nega Casino World আপনি কীভাবে সাইটটি ব্যবহার করেন সে সম্পর্কে ডেটা সংগ্রহ করে, যা আপনাকে ব্যক্তিগতভাবে শনাক্ত করে না। আপনি যখন সেবাগুলোর সাথে ইন্টারঅ্যাক্ট করেন, তখন আমাদের সার্ভার আপনার জন্য একটি অনন্য কার্যকলাপের লগ রাখে যা কিছু প্রশাসনিক ও ট্রাফিক তথ্য সংগ্রহ করে, যার মধ্যে রয়েছে: সোর্স IP ঠিকানা, প্রবেশের সময়, প্রবেশের তারিখ, পরিদর্শিত ওয়েব পেজ(সমূহ), ভাষার ব্যবহার, সফটওয়্যার ক্র্যাশ রিপোর্ট এবং ব্যবহৃত ব্রাউজারের ধরন। আমাদের সেবার সরবরাহ ও মানের জন্য এই তথ্য অপরিহার্য।</p>
      <h3>কুকিজ</h3>
      <p>Nega Casino World আমাদের ওয়েবসাইট যাতে দক্ষতার সাথে কাজ করে এবং আমাদের প্ল্যাটফর্মে আপনার পরিদর্শন উন্নত করার জন্য কুকিজ ব্যবহার করে। আরও তথ্য আমাদের কুকি নীতিতে পাওয়া যাবে।</p>
      ...
      <p>Nega Casino World আপনার বিবরণ যাচাই করার জন্য আপনার শনাক্তকরণ নথি এবং/অথবা ঠিকানার প্রমাণ ব্যবহার করবে যাতে আমরা আমাদের ব্যবহারকারীদের প্রতারণামূলক আচরণ থেকে রক্ষা করতে এবং দায়িত্বশীল জুয়াকে উৎসাহিত করতে পারি।</p>
      ...
      <h2>সংরক্ষণ</h2>
      <p>আমরা আইনি বা ব্যবসায়িক উদ্দেশ্যে যতক্ষণ যুক্তিসঙ্গতভাবে প্রয়োজন ততক্ষণ ব্যক্তিগত তথ্য ধরে রাখি। ডেটা সংরক্ষণের সময়কাল নির্ধারণে, Nega Casino World স্থানীয় আইন, চুক্তিগত বাধ্যবাধকতা এবং আমাদের গ্রাহকদের প্রত্যাশা ও প্রয়োজনীয়তা বিবেচনা করে। আমাদের যখন আর আপনার ব্যক্তিগত তথ্যের প্রয়োজন হয় না, তখন আমরা তা নিরাপদভাবে মুছে ফেলি বা ধ্বংস করি।</p>
      ...
      <h2>Analytics Google</h2>
      <h3>Analytics (Google Inc.)</h3>
      <p>Google Analytics হলো Google Inc. (“Google”) দ্বারা প্রদত্ত একটি ওয়েব বিশ্লেষণ সেবা। Google সংগৃহীত ডেটা ব্যবহার করে Nega Casino World এর ব্যবহার ট্র্যাক ও পরীক্ষা করতে, এর কার্যক্রম সম্পর্কে রিপোর্ট প্রস্তুত করতে এবং সেগুলো অন্যান্য Google সেবার সাথে শেয়ার করতে। Google সংগৃহীত ডেটা ব্যবহার করে তার নিজস্ব বিজ্ঞাপন নেটওয়ার্কের বিজ্ঞাপনগুলোকে প্রাসঙ্গিক ও ব্যক্তিগতকৃত করতে পারে। সংগৃহীত ব্যক্তিগত ডেটা: কুকিজ ও ব্যবহারের ডেটা।</p>
      <h2>দাবিত্যাগ</h2>
  ...
  'security': {
    title: 'Nega Casino World (NCW) Security',
    body: `
      ...
      <p>NCW aims to give you the best service and user experience at all times. One of our ways to deliver this is by the use of Cookies.</p>
      ...
      <h4>How NCW use Cookies</h4>
      <p>Generally, NCW use cookies to improve user experience. To give you a better view and understanding, we provided below how cookies are used on our websites.</p>
      <h4>Tracking and Analysis</h4>
      <p>Cookies are used to analyze website traffic to further improve our website services.</p>
      <p>Used to gather information which will be used for the NCW affiliate program.</p>
      <p>Analyze how users move inside the website and collect information about how visitors use our site. NCW use this information to compile reports and help us improve our service.</p>
      <h4>Functionality</h4>
      ...
      <p>NCW particularly uses session and persistent type of cookies. Session cookies which expires upon session logout and persistent which can be stored in your browser for a minute up to years depending on specific type of cookies.</p>
      ...
      <h4>NCW Official</h4>
      <p>Please be wary of unlicensed and unregulated entities attempting to replicate NCW websites with malicious intentions. These fake websites are not associated with NCW in any way and are beyond our control and protection. For the highest security standards, only play at Official NCW websites. For more information, visit <a href="https://mcwlink.co/mcwguidebd">https://mcwlink.co/mcwguidebd</a>.</p>
    `,
    titleBn: 'নেগা ক্যাসিনো ওয়ার্ল্ড (NCW) নিরাপত্তা',
    bodyBn: `
      ...
      <h4>কুকিজ নীতি</h4>
      <p>NCW সবসময় সেরা সেবা ও অভিজ্ঞতা দিতে চায়। এর একটি উপায় হলো কুকিজের ব্যবহার।</p>
      <h4>“কুকি” কী?</h4>
      ...
      <h4>NCW কীভাবে কুকি ব্যবহার করে</h4>
      ...
      <h4>NCW অফিসিয়াল</h4>
      <p>ক্ষতিকর উদ্দেশ্যে NCW ওয়েবসাইট নকল করার চেষ্টা করা অননুমোদিত সাইট থেকে সতর্ক থাকুন। এই ভুয়া সাইটগুলো NCW-এর সাথে সম্পর্কিত নয়। সর্বোচ্চ নিরাপত্তার জন্য শুধুমাত্র অফিসিয়াল NCW সাইটে খেলুন। আরও তথ্যের জন্য দেখুন <a href="https://mcwlink.co/mcwguidebd">https://mcwlink.co/mcwguidebd</a>।</p>
    `,
  },
  'responsible-gaming': {
    title: 'Responsible Gaming',
    body: `
      <p>Nega Casino World is here to provide an excellent and enjoyable gaming experience and recognize our responsibility in preventing problematic activity. We advise all players to take into account the following, and not game irresponsibly:</p>
      <ul>
    ...
    bodyBn: `
      <p>নেগা ক্যাসিনো ওয়ার্ল্ড একটি চমৎকার ও উপভোগ্য গেমিং অভিজ্ঞতা দিতে চায় এবং সমস্যাযুক্ত আচরণ প্রতিরোধে দায়বদ্ধ। আমরা সকল খেলোয়াড়কে নিচের বিষয়গুলো বিবেচনায় নিতে এবং দায়িত্বজ্ঞানহীনভাবে না খেলতে পরামর্শ দিই:</p>
      <ul>
  ...
  'for-age-18-and-above-only': {
    ...
    body: `
      <p>Nega Casino World is only made available to customers aged 18 and above only. The act of a customer under the age of 18 opening an account and/or gambling on Nega Casino World is considered as an offence. Nega Casino World carries out age-verifications and reserves the right to carry out such verifications at our own discretion. The company has responsibilities to carry out age verifications and we take it very seriously. Customers that have been requested to complete age verifications will not be able to use any of our payment services until the age verification is complete. Nega Casino World reserves the rights to suspend your account while pending for your age verification.</p>
      ...
      <p>Nega Casino World strongly encourages and advises all its customers to ensure that minors would not access any e-gaming websites.</p>
      <p>Parents can regulate internet access with filtering solutions based on selected criteria. With filtering solutions, parents can regulate internet access and prevent minors from accessing e-gaming websites. Filtering solutions can deny access to Nega Casino World after detecting the content on our site and the solutions can achieve that because we label our website. If your device is shared among family and friends who are minors, please consider using parental filtering solutions to deny them access to Nega Casino World.</p>
    `,
    titleBn: 'শুধুমাত্র ১৮ বছর ও তার বেশি বয়সীদের জন্য',
    bodyBn: `
      <p>নেগা ক্যাসিনো ওয়ার্ল্ড শুধুমাত্র ১৮ বছর ও তার বেশি বয়সী গ্রাহকদের জন্য উপলব্ধ। ১৮ বছরের কম বয়সী কারও অ্যাকাউন্ট খোলা বা বাজি ধরা অপরাধ হিসেবে গণ্য। আমরা বয়স যাচাই করি এবং নিজস্ব বিবেচনায় তা করার অধিকার সংরক্ষণ করি। বয়স যাচাই সম্পন্ন না হওয়া পর্যন্ত গ্রাহক কোনো পেমেন্ট সেবা ব্যবহার করতে পারবেন না।</p>
      <p><strong>দ্রষ্টব্য: ১৮ বছরের কম বয়সী কাউকে নেগা ক্যাসিনো ওয়ার্ল্ড ব্যবহার করতে দেখা গেলে কোম্পানি অ্যাকাউন্ট ব্লক এবং সমস্ত জেতা টাকা বাজেয়াপ্ত করার অধিকার রাখে।</strong></p>
      <h4>ফিল্টারিং সিস্টেম</h4>
      <p>নেগা ক্যাসিনো ওয়ার্ল্ড দৃঢ়ভাবে পরামর্শ দেয় যেন নাবালকরা কোনো ই-গেমিং ওয়েবসাইটে প্রবেশ করতে না পারে।</p>
  ...
  'faq': {
    ...
    body: `
      ...
      <p class="content-page__lead" style="text-align: center;">এইগুলি NCW সম্পর্কে কিছু সাধারণ প্রশ্ন এবং উত্তর। আপনি যদি নীচের তালিকায় আপনার প্রশ্নটি খুঁজে না পান, দয়া করে আমাদের গ্রাহক সহায়তার সাথে যোগাযোগ করুন।</p>
